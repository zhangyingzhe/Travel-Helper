...
public class FavoriteAdapter extends RecyclerView.Adapter<FavoriteAdapter.VHolder> implements View.OnClickListener {
    private List data;
    ...
    public FavoriteAdapter(Context context, List myDataset) {
